Craft.Bounds = (function() {
	...
	Bounds.prototype.update = function() {
		...
		this.extents = vec3.fromValues(this.size.x / 2, this.size.y / 2, this.size.z / 2);
		this.max = vec3.fromValues(this.center.x + this.extents.x, this.center.y + this.extents.y, this.center.z + this.extents.z);
		this.min = vec3.fromValues(this.center.x - this.extents.x, this.center.y - this.extents.y, this.center.z - this.extents.z);
